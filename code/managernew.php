...
function renderForm($mk_managerfirst, $mk_managerlast, $mk_managerstate, $mk_managercity, $mk_manageremail, $mk_managercompany, $mk_managertitle, $mk_managercellfirst, $mk_managercellmiddle, $mk_managercelllast, $error)
...
<strong>Manager's State            : *</strong> <input type="text" name="mk_managerstate" value="<?php echo $mk_managerstate; ?>" /><br/>

<strong>Manager's City             : *</strong> <input type="text" name="mk_managercity" value="<?php echo $mk_managercity; ?>" /><br/>
...
$mk_managerstate = mysqli_real_escape_string($databaseConnection, $_POST['mk_managerstate']);
$mk_managercity = mysqli_real_escape_string($databaseConnection, $_POST['mk_managercity']);
...
renderForm($mk_managerfirst, $mk_managerlast, $mk_managerstate, $mk_managercity, $mk_manageremail, $mk_managercompany, $mk_managertitle, $mk_managercellfirst, $mk_managercellmiddle, $mk_managercelllast, $error);
}
...
$sql = "INSERT INTO manager (mk_managerfirst, mk_managerlast, mk_managerstate, mk_managercity, mk_manageremail, mk_managercompany, mk_managertitle, mk_managercellfirst, mk_managercellmiddle, mk_managercelllast) 
VALUES ('$mk_managerfirst', '$mk_managerlast', '$mk_managerstate', '$mk_managercity', '$mk_manageremail', '$mk_managercompany', '$mk_managertitle', '$mk_managercellfirst', '$mk_managercellmiddle', '$mk_managercelllast');";

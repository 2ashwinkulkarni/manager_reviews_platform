    ...
    <div class="w3-quarter">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-display-container">            
              ...
              <img src="Images\Mayuresh Picture.jpg" style="width:100%" alt="Avatar">
...
print $mk_managerfirst . " " . $mk_managerlast;
?>
</h2> 
          <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i>KPMG</p>

...
echo "<tr> <th>ID</th> <th>First Name</th> <th>Last Name</th> <th>State</th> <th>City</th> <th>email</th> <th>Company Name</th> <th>Title</th> <th>Cell First</th> <th>Cell Middle</th> <th>Cell Last</th> <th>Cell Phone</th> <th>Edit</th> <th>Delete</th> <th>View Review</th> </tr>";
...
// loop through results of database query, displaying them in the table
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td>'.$row["mk_managerstate"]."</td>";
        echo '<td>'.$row["mk_managercity"]."</td>";
